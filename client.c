    ...
    while (1){
        ...
        if(start == 0) {
            ...
            case 2: ;
                ...
                send_message_struct_connect2[0].iov_base = command_client_chat;
                send_message_struct_connect2[0].iov_len = strlen(command_client_chat);
                ...
                memset(send_message_struct_connect2[1].iov_base,0,strlen(send_message_struct_connect[1].iov_base));
                sleep(1);
                printf("\n");
                break;
            case 3: ;
            ...
            case 4: ;
                ...
                send_message_struct_connect3[0].iov_base = command_client_log;
                send_message_struct_connect3[0].iov_len = strlen(command_client_log);
